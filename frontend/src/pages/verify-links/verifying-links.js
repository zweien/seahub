...
class ItemVerifying extends Component {
  ...
  viewStatus = (e) => {
    e.preventDefault();
    this.props.showModal({content: this.props.item.verbose_status_str});
  }
...
class VerifyingLinks extends Component {
  ...
  onShowVerifyingContent = (isShowVerifyingContent) => {
    this.getVerifyShareLinks(isShowVerifyingContent);
    this.setState({
          ...
          <div className="cur-view-path share-upload-nav">
            <ul className="nav">
              <li className="nav-item">
                <a onClick={() => {this.onShowVerifyingContent(true);}} className={classnames('nav-link', { active: isShowVerifying })}>{'正在审核的链接'}</a>
              </li>
              <li className="nav-item">
                <a onClick={() => {this.onShowVerifyingContent(false);}} className={classnames('nav-link', { active: !isShowVerifying })}>{'已审核的链接'}</a>
              </li>
            </ul>
          </div>
